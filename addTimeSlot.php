	...
	<div class="bg" ">
		...
		<div class="container">  
			<form id="contact" action="addTimeSlot.php" method="post" enctype="multipart/form-data">
				...
				<input  name="timeSlot" placeholder="Time Slot" type="integer" tabindex="1" required autofocus>
...
<?php 
class AddProduct{
	public function productAdd($conn,$timeSlot)
	{
		$sql="delete from movieList where movieId=$timeSlot";
		...
		$stmt->execute();
		$stmt->close();
		$_SESSION['msg']="Movie successfully deleted";
